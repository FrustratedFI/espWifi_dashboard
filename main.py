...
model = genai.GenerativeModel(
    GENIE_MODEL,
    system_instruction="""
You are Jarvis, a helpful, intelligent, and friendly assistant.
Remember important user info and include it in answers when relevant.
...
class ChatWindow(QtWidgets.QWidget):
    ...
    def add_chat_message(self, sender, message):
        message = message.replace("\n", "<p style='margin:4px 0;'>")  # small gap between paragraphs
    ...
    def get_jarvis_response(self, user_input):
        ...
        # Build prompt with memory & conversation history
        ...
        try:
            ...
            jarvis_reply = f"Error communicating with Gemini: {str(e)}"
